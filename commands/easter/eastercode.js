...
+ ${Math.floor((20160 - minutiPassati) / 10 * code.difficulty)} XP
+ ${Math.floor((20160 - minutiPassati) / 20 * code.difficulty)} Coins
`)
        ...
        userstats = await addXp(userstats, Math.floor((20160 - minutiPassati) / 10 * code.difficulty), 0, true);
        userstats.money += Math.floor((20160 - minutiPassati) / 20 * code.difficulty)
