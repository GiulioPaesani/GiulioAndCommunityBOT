module.exports = {
    name: "cserver",
    aliases: ["cserverstats", "clb", "cleaderboard", "cs"],
    onlyStaff: false,
    availableOnDM: true,
    description: "Visualizzare statistiche counting del server",
    syntax: "!cserver",
    category: "fun",
    ...
    async execute(message, args, client, property) {
        ...
        var button1 = new Discord.MessageButton()
            .setCustomId(`indietro2Clb,${message.author.id},${page}`)
            .setStyle("PRIMARY")
            .setEmoji("⏮️")

        var button2 = new Discord.MessageButton()
            .setCustomId(`indietroClb,${message.author.id},${page}`)
            .setStyle("PRIMARY")
            .setEmoji("◀️")
        ...
        var button3 = new Discord.MessageButton()
            .setCustomId(`avantiClb,${message.author.id},${page}`)
            .setStyle("PRIMARY")
            .setEmoji("▶️")

        var button4 = new Discord.MessageButton()
            .setCustomId(`avanti2Clb,${message.author.id},${page}`)
            .setStyle("PRIMARY")
            .setEmoji("⏭️")
