module.exports = {
    ...
    async execute(message, args, client, property) {
        ...
        var button1 = new disbut.MessageButton()
            .setID(`indietro2Clb,${message.author.id},${page}`)
            .setStyle("blurple")
            .setEmoji("⏮️")

        var button2 = new disbut.MessageButton()
            .setID(`indietroClb,${message.author.id},${page}`)
            .setStyle("blurple")
            .setEmoji("◀️")
        ...
        var button3 = new disbut.MessageButton()
            .setID(`avantiClb,${message.author.id},${page}`)
            .setStyle("blurple")
            .setEmoji("▶️")

        var button4 = new disbut.MessageButton()
            .setID(`avanti2Clb,${message.author.id},${page}`)
            .setStyle("blurple")
            .setEmoji("⏭️")
