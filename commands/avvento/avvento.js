module.exports = {
    ...
    async execute(message, args, client, property) {
        ...
        for (var i = 21; i <= 25; i++) {
            ...
            if (i == 21)
                text += avvento[21] ? `From: ${new Date(avvento.boost3).getDate()}/${new Date(avvento.boost3).getMonth() + 1} ${new Date(avvento.boost3).getHours() < 10 ? ("0" + new Date(avvento.boost3).getHours()) : new Date(avvento.boost3).getHours()}:${new Date(avvento.boost3).getMinutes() < 10 ? ("0" + new Date(avvento.boost3).getMinutes()) : new Date(avvento.boost3).getMinutes()} To: ${new Date(avvento.boost3 + 43200000).getDate()}/${new Date(avvento.boost3 + 43200000).getMonth() + 1} ${new Date(avvento.boost3 + 43200000).getHours() < 10 ? ("0" + new Date(avvento.boost3 + 43200000).getHours()) : new Date(avvento.boost3 + 43200000).getHours()}:${new Date(avvento.boost3 + 43200000).getMinutes() < 10 ? ("0" + new Date(avvento.boost3 + 43200000).getMinutes()) : new Date(avvento.boost3 + 43200000).getMinutes()}\r` : ""
            if (i == 23)
