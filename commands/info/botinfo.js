...
module.exports = {
    ...
    async execute(client, interaction, comando) {
        ...
        let embed = new Discord.MessageEmbed()
            ...
            .addField(":construction: Maintenance", maintenanceStatus == 0 ? `Off - Everyone can use bot` : maintenanceStatus == 1 ? `Mode 1 - Only tester can use bot` : maintenanceStatus == 2 ? `Mode 2 - Nobody can use bot` : maintenanceStatus == 3 ? `Mode 3 - Everyone, except testers, can use bot` : "", true)
