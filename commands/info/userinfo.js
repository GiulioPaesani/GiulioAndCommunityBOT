...
module.exports = {
    ...
    async execute(client, interaction, comando) {
        ...
        let embed = new Discord.MessageEmbed()
            ...
            .addField(":red_car: Joined this server", utente.user ? `${moment(userstats.joinedAt || utente.joinedTimestamp).format("ddd DD MMM YYYY, HH:mm")} (${moment(userstats.joinedAt || utente.joinedTimestamp).fromNow()})` : "_User never joined the server_")
