...
client.on("messageCreate", message => {
    if (message.content == "!comando") {
        const embed = new Discord.EmbedBuilder()
            ...
            //Aggiungere elementi
            .addFields([{ name: "Titolo", value: "Contenuto", inline: true }]) //QUI TUTTI I PARAMETRI SONO OBBLIGATORI - True o false = se questo elemento deve essere in linea con gli altri
            .setImage("LinkImmagine") //Immagine
            .setFooter({ text: "TestoFooter" }) // Testo piccolino in fondo
            .setTimestamp() //Se mettere o no l'orario di arrivo del 
