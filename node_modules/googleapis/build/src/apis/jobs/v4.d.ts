...
export declare namespace jobs_v4 {
     ...
     */
    export interface Schema$GoogleCloudTalentV4BatchCreateJobsRequest {
        /**
         * Required. The jobs to be created. A maximum of 200 jobs can be created in a batch.
         */
        jobs?: Schema$GoogleCloudTalentV4Job[];
    }
    /**
     ...
     */
    export interface Schema$GoogleCloudTalentV4BatchDeleteJobsRequest {
        /**
     ...
     */
    export interface Schema$GoogleCloudTalentV4BatchUpdateJobsRequest {
        /**
     ...
     */
    export interface Schema$GoogleCloudTalentV4ClientEvent {
        /**
         ...
         */
        jobEvent?: Schema$GoogleCloudTalentV4JobEvent;
        /**
     ...
     */
    export interface Schema$GoogleCloudTalentV4CommuteFilter {
        /**
     ...
     */
    export interface Schema$GoogleCloudTalentV4Company {
        /**
         ...
         */
        derivedInfo?: Schema$GoogleCloudTalentV4CompanyDerivedInfo;
        /**
     ...
     */
    export interface Schema$GoogleCloudTalentV4CompanyDerivedInfo {
        /**
         * A structured headquarters location of the company, resolved from Company.headquarters_address if provided.
         */
        headquartersLocation?: Schema$GoogleCloudTalentV4Location;
    }
    /**
     * Filter on job compensation type and amount.
     */
    export interface Schema$GoogleCloudTalentV4CompensationFilter {
        /**
     ...
     */
    export interface Schema$GoogleCloudTalentV4CompleteQueryResponse {
        /**
         * Results of the matching job/company candidates.
         */
        completionResults?: Schema$GoogleCloudTalentV4CompleteQueryResponseCompletionResult[];
        /**
         * Additional information for the API invocation, such as the request tracking id.
         */
        metadata?: Schema$GoogleCloudTalentV4ResponseMetadata;
    }
    /**
     * Resource that represents completion results.
     */
    export interface Schema$GoogleCloudTalentV4CompleteQueryResponseCompletionResult {
        /**
     ...
     */
    export interface Schema$GoogleCloudTalentV4DeviceInfo {
        /**
         * Type of the device.
         */
     ...
     */
    export interface Schema$GoogleCloudTalentV4HistogramQuery {
        /**
     ...
     */
    export interface Schema$GoogleCloudTalentV4HistogramQueryResult {
        /**
     ...
     * An event issued when a job seeker interacts with the application that implements Cloud Talent Solution.
     */
    export interface Schema$GoogleCloudTalentV4JobEvent {
        /**
     ...
     */
    export interface Schema$GoogleCloudTalentV4JobQuery {
        /**
         ...
         */
        commuteFilter?: Schema$GoogleCloudTalentV4CommuteFilter;
        /**
         ...
         */
        compensationFilter?: Schema$GoogleCloudTalentV4CompensationFilter;
        /**
         ...
         */
        locationFilters?: Schema$GoogleCloudTalentV4LocationFilter[];
        /**
         * Jobs published within a range specified by this filter are searched against.
         */
        publishTimeRange?: Schema$GoogleCloudTalentV4TimestampRange;
        /**
     ...
     */
    export interface Schema$GoogleCloudTalentV4ListCompaniesResponse {
        /**
         * Companies for the current client.
         */
        companies?: Schema$GoogleCloudTalentV4Company[];
        /**
         * Additional information for the API invocation, such as the request tracking id.
         */
        metadata?: Schema$GoogleCloudTalentV4ResponseMetadata;
     ...
     * List jobs response.
     */
    export interface Schema$GoogleCloudTalentV4ListJobsResponse {
        /**
     ...
     */
    export interface Schema$GoogleCloudTalentV4ListTenantsResponse {
        /**
         * Additional information for the API invocation, such as the request tracking id.
         */
        metadata?: Schema$GoogleCloudTalentV4ResponseMetadata;
         ...
         */
        tenants?: Schema$GoogleCloudTalentV4Tenant[];
    }
    /**
     ...
     */
    export interface Schema$GoogleCloudTalentV4LocationFilter {
        /**
     ...
     */
    export interface Schema$GoogleCloudTalentV4RequestMetadata {
        /**
         ...
         */
        deviceInfo?: Schema$GoogleCloudTalentV4DeviceInfo;
        /**
     ...
     */
    export interface Schema$GoogleCloudTalentV4ResponseMetadata {
        /**
     ...
     */
    export interface Schema$GoogleCloudTalentV4SearchJobsRequest {
        /**
         * Controls over how job documents get ranked on top of existing relevance score (determined by API algorithm).
         */
        customRankingInfo?: Schema$GoogleCloudTalentV4SearchJobsRequestCustomRankingInfo;
        /**
         ...
         */
        histogramQueries?: Schema$GoogleCloudTalentV4HistogramQuery[];
        /**
         * Query used to search against jobs, such as keyword, location filters, etc.
         */
        jobQuery?: Schema$GoogleCloudTalentV4JobQuery;
        /**
         ...
         */
        requestMetadata?: Schema$GoogleCloudTalentV4RequestMetadata;
        /**
     ...
     */
    export interface Schema$GoogleCloudTalentV4SearchJobsRequestCustomRankingInfo {
        /**
     ...
     */
    export interface Schema$GoogleCloudTalentV4SearchJobsResponse {
        /**
         ...
         */
        histogramQueryResults?: Schema$GoogleCloudTalentV4HistogramQueryResult[];
        /**
         ...
         */
        locationFilters?: Schema$GoogleCloudTalentV4Location[];
        /**
         * The Job entities that match the specified SearchJobsRequest.
         */
        matchingJobs?: Schema$GoogleCloudTalentV4SearchJobsResponseMatchingJob[];
        /**
         * Additional information for the API invocation, such as the request tracking id.
         */
        metadata?: Schema$GoogleCloudTalentV4ResponseMetadata;
         ...
         */
        spellCorrection?: Schema$GoogleCloudTalentV4SpellingCorrection;
        /**
     ...
     */
    export interface Schema$GoogleCloudTalentV4SearchJobsResponseCommuteInfo {
        /**
         * Location used as the destination in the commute calculation.
         */
        jobLocation?: Schema$GoogleCloudTalentV4Location;
        /**
     ...
     */
    export interface Schema$GoogleCloudTalentV4SearchJobsResponseMatchingJob {
        /**
         * Commute information which is generated based on specified CommuteFilter.
         */
        commuteInfo?: Schema$GoogleCloudTalentV4SearchJobsResponseCommuteInfo;
        /**
     ...
     * Spell check result.
     */
    export interface Schema$GoogleCloudTalentV4SpellingCorrection {
        /**
     ...
     */
    export interface Schema$GoogleCloudTalentV4Tenant {
        /**
     ...
     */
    export interface Schema$GoogleCloudTalentV4TimestampRange {
        /**
     ...
     */
    export interface Schema$JobOperationResult {
        /**
    ...
    export class Resource$Projects$Tenants {
        ...
        completeQuery(params?: Params$Resource$Projects$Tenants$Completequery, options?: MethodOptions): GaxiosPromise<Schema$GoogleCloudTalentV4CompleteQueryResponse>;
        ...
        completeQuery(params: Params$Resource$Projects$Tenants$Completequery, options: MethodOptions | BodyResponseCallback<Schema$GoogleCloudTalentV4CompleteQueryResponse>, callback: BodyResponseCallback<Schema$GoogleCloudTalentV4CompleteQueryResponse>): void;
        completeQuery(params: Params$Resource$Projects$Tenants$Completequery, callback: BodyResponseCallback<Schema$GoogleCloudTalentV4CompleteQueryResponse>): void;
        completeQuery(callback: BodyResponseCallback<Schema$GoogleCloudTalentV4CompleteQueryResponse>): void;
        /**
        ...
        create(params?: Params$Resource$Projects$Tenants$Create, options?: MethodOptions): GaxiosPromise<Schema$GoogleCloudTalentV4Tenant>;
        ...
        create(params: Params$Resource$Projects$Tenants$Create, options: MethodOptions | BodyResponseCallback<Schema$GoogleCloudTalentV4Tenant>, callback: BodyResponseCallback<Schema$GoogleCloudTalentV4Tenant>): void;
        create(params: Params$Resource$Projects$Tenants$Create, callback: BodyResponseCallback<Schema$GoogleCloudTalentV4Tenant>): void;
        create(callback: BodyResponseCallback<Schema$GoogleCloudTalentV4Tenant>): void;
        /**
        ...
        get(params?: Params$Resource$Projects$Tenants$Get, options?: MethodOptions): GaxiosPromise<Schema$GoogleCloudTalentV4Tenant>;
        ...
        get(params: Params$Resource$Projects$Tenants$Get, options: MethodOptions | BodyResponseCallback<Schema$GoogleCloudTalentV4Tenant>, callback: BodyResponseCallback<Schema$GoogleCloudTalentV4Tenant>): void;
        get(params: Params$Resource$Projects$Tenants$Get, callback: BodyResponseCallback<Schema$GoogleCloudTalentV4Tenant>): void;
        get(callback: BodyResponseCallback<Schema$GoogleCloudTalentV4Tenant>): void;
        /**
        ...
        list(params?: Params$Resource$Projects$Tenants$List, options?: MethodOptions): GaxiosPromise<Schema$GoogleCloudTalentV4ListTenantsResponse>;
        ...
        list(params: Params$Resource$Projects$Tenants$List, options: MethodOptions | BodyResponseCallback<Schema$GoogleCloudTalentV4ListTenantsResponse>, callback: BodyResponseCallback<Schema$GoogleCloudTalentV4ListTenantsResponse>): void;
        list(params: Params$Resource$Projects$Tenants$List, callback: BodyResponseCallback<Schema$GoogleCloudTalentV4ListTenantsResponse>): void;
        list(callback: BodyResponseCallback<Schema$GoogleCloudTalentV4ListTenantsResponse>): void;
        /**
        ...
        patch(params?: Params$Resource$Projects$Tenants$Patch, options?: MethodOptions): GaxiosPromise<Schema$GoogleCloudTalentV4Tenant>;
        ...
        patch(params: Params$Resource$Projects$Tenants$Patch, options: MethodOptions | BodyResponseCallback<Schema$GoogleCloudTalentV4Tenant>, callback: BodyResponseCallback<Schema$GoogleCloudTalentV4Tenant>): void;
        patch(params: Params$Resource$Projects$Tenants$Patch, callback: BodyResponseCallback<Schema$GoogleCloudTalentV4Tenant>): void;
        patch(callback: BodyResponseCallback<Schema$GoogleCloudTalentV4Tenant>): void;
    }
    ...
    export interface Params$Resource$Projects$Tenants$Create extends StandardParameters {
         ...
         * Request body metadata
         */
        requestBody?: Schema$GoogleCloudTalentV4Tenant;
    }
    ...
    export class Resource$Projects$Tenants$Clientevents {
        ...
        create(params?: Params$Resource$Projects$Tenants$Clientevents$Create, options?: MethodOptions): GaxiosPromise<Schema$GoogleCloudTalentV4ClientEvent>;
        ...
        create(params: Params$Resource$Projects$Tenants$Clientevents$Create, options: MethodOptions | BodyResponseCallback<Schema$GoogleCloudTalentV4ClientEvent>, callback: BodyResponseCallback<Schema$GoogleCloudTalentV4ClientEvent>): void;
        create(params: Params$Resource$Projects$Tenants$Clientevents$Create, callback: BodyResponseCallback<Schema$GoogleCloudTalentV4ClientEvent>): void;
        create(callback: BodyResponseCallback<Schema$GoogleCloudTalentV4ClientEvent>): void;
    }
    export interface Params$Resource$Projects$Tenants$Clientevents$Create extends StandardParameters {
         ...
         * Request body metadata
         */
        requestBody?: Schema$GoogleCloudTalentV4ClientEvent;
    }
    export class Resource$Projects$Tenants$Companies {
        ...
        create(params?: Params$Resource$Projects$Tenants$Companies$Create, options?: MethodOptions): GaxiosPromise<Schema$GoogleCloudTalentV4Company>;
        ...
        create(params: Params$Resource$Projects$Tenants$Companies$Create, options: MethodOptions | BodyResponseCallback<Schema$GoogleCloudTalentV4Company>, callback: BodyResponseCallback<Schema$GoogleCloudTalentV4Company>): void;
        create(params: Params$Resource$Projects$Tenants$Companies$Create, callback: BodyResponseCallback<Schema$GoogleCloudTalentV4Company>): void;
        create(callback: BodyResponseCallback<Schema$GoogleCloudTalentV4Company>): void;
        /**
        ...
        get(params?: Params$Resource$Projects$Tenants$Companies$Get, options?: MethodOptions): GaxiosPromise<Schema$GoogleCloudTalentV4Company>;
        ...
        get(params: Params$Resource$Projects$Tenants$Companies$Get, options: MethodOptions | BodyResponseCallback<Schema$GoogleCloudTalentV4Company>, callback: BodyResponseCallback<Schema$GoogleCloudTalentV4Company>): void;
        get(params: Params$Resource$Projects$Tenants$Companies$Get, callback: BodyResponseCallback<Schema$GoogleCloudTalentV4Company>): void;
        get(callback: BodyResponseCallback<Schema$GoogleCloudTalentV4Company>): void;
        /**
        ...
        list(params?: Params$Resource$Projects$Tenants$Companies$List, options?: MethodOptions): GaxiosPromise<Schema$GoogleCloudTalentV4ListCompaniesResponse>;
        ...
        list(params: Params$Resource$Projects$Tenants$Companies$List, options: MethodOptions | BodyResponseCallback<Schema$GoogleCloudTalentV4ListCompaniesResponse>, callback: BodyResponseCallback<Schema$GoogleCloudTalentV4ListCompaniesResponse>): void;
        list(params: Params$Resource$Projects$Tenants$Companies$List, callback: BodyResponseCallback<Schema$GoogleCloudTalentV4ListCompaniesResponse>): void;
        list(callback: BodyResponseCallback<Schema$GoogleCloudTalentV4ListCompaniesResponse>): void;
        /**
        ...
        patch(params?: Params$Resource$Projects$Tenants$Companies$Patch, options?: MethodOptions): GaxiosPromise<Schema$GoogleCloudTalentV4Company>;
        ...
        patch(params: Params$Resource$Projects$Tenants$Companies$Patch, options: MethodOptions | BodyResponseCallback<Schema$GoogleCloudTalentV4Company>, callback: BodyResponseCallback<Schema$GoogleCloudTalentV4Company>): void;
        patch(params: Params$Resource$Projects$Tenants$Companies$Patch, callback: BodyResponseCallback<Schema$GoogleCloudTalentV4Company>): void;
        patch(callback: BodyResponseCallback<Schema$GoogleCloudTalentV4Company>): void;
    }
    export interface Params$Resource$Projects$Tenants$Companies$Create extends StandardParameters {
         ...
         * Request body metadata
         */
        requestBody?: Schema$GoogleCloudTalentV4Company;
    }
    ...
    export class Resource$Projects$Tenants$Jobs {
        ...
        create(params?: Params$Resource$Projects$Tenants$Jobs$Create, options?: MethodOptions): GaxiosPromise<Schema$GoogleCloudTalentV4Job>;
        ...
        create(params: Params$Resource$Projects$Tenants$Jobs$Create, options: MethodOptions | BodyResponseCallback<Schema$GoogleCloudTalentV4Job>, callback: BodyResponseCallback<Schema$GoogleCloudTalentV4Job>): void;
        create(params: Params$Resource$Projects$Tenants$Jobs$Create, callback: BodyResponseCallback<Schema$GoogleCloudTalentV4Job>): void;
        create(callback: BodyResponseCallback<Schema$GoogleCloudTalentV4Job>): void;
        /**
        ...
        get(params?: Params$Resource$Projects$Tenants$Jobs$Get, options?: MethodOptions): GaxiosPromise<Schema$GoogleCloudTalentV4Job>;
        ...
        get(params: Params$Resource$Projects$Tenants$Jobs$Get, options: MethodOptions | BodyResponseCallback<Schema$GoogleCloudTalentV4Job>, callback: BodyResponseCallback<Schema$GoogleCloudTalentV4Job>): void;
        get(params: Params$Resource$Projects$Tenants$Jobs$Get, callback: BodyResponseCallback<Schema$GoogleCloudTalentV4Job>): void;
        get(callback: BodyResponseCallback<Schema$GoogleCloudTalentV4Job>): void;
        /**
        ...
        list(params?: Params$Resource$Projects$Tenants$Jobs$List, options?: MethodOptions): GaxiosPromise<Schema$GoogleCloudTalentV4ListJobsResponse>;
        ...
        list(params: Params$Resource$Projects$Tenants$Jobs$List, options: MethodOptions | BodyResponseCallback<Schema$GoogleCloudTalentV4ListJobsResponse>, callback: BodyResponseCallback<Schema$GoogleCloudTalentV4ListJobsResponse>): void;
        list(params: Params$Resource$Projects$Tenants$Jobs$List, callback: BodyResponseCallback<Schema$GoogleCloudTalentV4ListJobsResponse>): void;
        list(callback: BodyResponseCallback<Schema$GoogleCloudTalentV4ListJobsResponse>): void;
        /**
        ...
        patch(params?: Params$Resource$Projects$Tenants$Jobs$Patch, options?: MethodOptions): GaxiosPromise<Schema$GoogleCloudTalentV4Job>;
        ...
        patch(params: Params$Resource$Projects$Tenants$Jobs$Patch, options: MethodOptions | BodyResponseCallback<Schema$GoogleCloudTalentV4Job>, callback: BodyResponseCallback<Schema$GoogleCloudTalentV4Job>): void;
        patch(params: Params$Resource$Projects$Tenants$Jobs$Patch, callback: BodyResponseCallback<Schema$GoogleCloudTalentV4Job>): void;
        patch(callback: BodyResponseCallback<Schema$GoogleCloudTalentV4Job>): void;
        /**
        ...
        search(params?: Params$Resource$Projects$Tenants$Jobs$Search, options?: MethodOptions): GaxiosPromise<Schema$GoogleCloudTalentV4SearchJobsResponse>;
        ...
        search(params: Params$Resource$Projects$Tenants$Jobs$Search, options: MethodOptions | BodyResponseCallback<Schema$GoogleCloudTalentV4SearchJobsResponse>, callback: BodyResponseCallback<Schema$GoogleCloudTalentV4SearchJobsResponse>): void;
        search(params: Params$Resource$Projects$Tenants$Jobs$Search, callback: BodyResponseCallback<Schema$GoogleCloudTalentV4SearchJobsResponse>): void;
        search(callback: BodyResponseCallback<Schema$GoogleCloudTalentV4SearchJobsResponse>): void;
        /**
        ...
        searchForAlert(params?: Params$Resource$Projects$Tenants$Jobs$Searchforalert, options?: MethodOptions): GaxiosPromise<Schema$GoogleCloudTalentV4SearchJobsResponse>;
        ...
        searchForAlert(params: Params$Resource$Projects$Tenants$Jobs$Searchforalert, options: MethodOptions | BodyResponseCallback<Schema$GoogleCloudTalentV4SearchJobsResponse>, callback: BodyResponseCallback<Schema$GoogleCloudTalentV4SearchJobsResponse>): void;
        searchForAlert(params: Params$Resource$Projects$Tenants$Jobs$Searchforalert, callback: BodyResponseCallback<Schema$GoogleCloudTalentV4SearchJobsResponse>): void;
        searchForAlert(callback: BodyResponseCallback<Schema$GoogleCloudTalentV4SearchJobsResponse>): void;
    }
    export interface Params$Resource$Projects$Tenants$Jobs$Batchcreate extends StandardParameters {
         ...
         * Request body metadata
         */
        requestBody?: Schema$GoogleCloudTalentV4BatchCreateJobsRequest;
    }
    export interface Params$Resource$Projects$Tenants$Jobs$Batchdelete extends StandardParameters {
         ...
         * Request body metadata
         */
        requestBody?: Schema$GoogleCloudTalentV4BatchDeleteJobsRequest;
    }
    export interface Params$Resource$Projects$Tenants$Jobs$Batchupdate extends StandardParameters {
         ...
         * Request body metadata
         */
        requestBody?: Schema$GoogleCloudTalentV4BatchUpdateJobsRequest;
    }
    export interface Params$Resource$Projects$Tenants$Jobs$Create extends StandardParameters {
         ...
         * Request body metadata
         */
        requestBody?: Schema$GoogleCloudTalentV4Job;
    }
    ...
    export interface Params$Resource$Projects$Tenants$Jobs$Search extends StandardParameters {
         ...
         * Request body metadata
         */
        requestBody?: Schema$GoogleCloudTalentV4SearchJobsRequest;
    }
