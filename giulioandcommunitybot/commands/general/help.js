...
module.exports = {
    ...
    async execute(client, interaction, comando) {
        ...
        if (command) {
            ...
            let command = client.commands.get(interaction.options.getString("command")) || moderactionCommands.find(x => x.name == interaction.options.getString("command")) || funCommands.find(x => x.name == interaction.options.getString("command")) || rankingCommands.find(x => x.name == interaction.options.getString("command"))
