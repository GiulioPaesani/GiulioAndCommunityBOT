...
module.exports = {
    ...
    async execute(client, interaction) {
        ...
        if (!interaction.customId.startsWith("birthdayListIndietro")) return
        ...
        if (day) {
            month = moment([2020, parseInt(interaction.customId.split(",")[1]) - 1, parseInt(interaction.customId.split(",")[2])]).subtract(1, 'days').month() + 1
            day = moment([2020, parseInt(interaction.customId.split(",")[1]) - 1, parseInt(interaction.customId.split(",")[2])]).subtract(1, 'days').date()
...
${birthdayList || "_Nessun compleanno_"}`)
            ...
            month = moment([2020, parseInt(interaction.customId.split(",")[1]) - 1]).subtract(1, "month").month() + 1
