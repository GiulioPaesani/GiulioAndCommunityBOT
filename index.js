    ...
    con.query(`SELECT * FROM serverstats`, function (err, result, fields) {
        ...
        if (message.content.startsWith("!user")) {
            ...
            var userStats = new Discord.MessageEmbed()
                ...
                .addField(":pencil: Account created", "```" + utente.user.createdAt.toDateString() + " (" + moment(utente.user.createdAt.getTime()).fromNow() + ")```", true)
                .addField(":red_car: Joined this server", "```" + new Date(utente.joinedTimestamp).toDateString() + " (" + moment(new Date(utente.joinedTimestamp).getTime()).fromNow() + ")```", true)
