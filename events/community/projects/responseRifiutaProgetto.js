...
module.exports = {
    ...
    async execute(client, message) {
        ...
        if (message.channel.id != log.community.projects) return
        ...
        client.channels.cache.get(log.community.projects).messages.fetch(message.reference.messageId)
            .then(msg => {
                ...
                let embed = new Discord.MessageEmbed()
                    ...
                    .addField(msg.embeds[0].fields[2].value, msg.embeds[0].fields[3].value)
