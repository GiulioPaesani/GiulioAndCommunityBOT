module.exports = {
    ...
    async execute(messageReaction, user) {
        ...
        if (messageReaction.message.channel.id == settings.idCanaliServer.suggestions) {
            try {
                ...
                userUp = userUp.filter(x => x != settings.idBot)
                userDown = userDown.filter(x => x != settings.idBot)
