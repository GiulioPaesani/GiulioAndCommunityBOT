...
:point_right: Ora si ricomincia da \`${serverstats.countingplus.number}\` e ogni volta si ${serverstats.countingplus.operator == "+" ? "**aggiunge**" : serverstats.countingplus.operator == "-" ? "**sottrae**" : "**moltiplica** per"} \`${serverstats.countingplus.gap}\``)
            ...
            message.channel.send({ embeds: [embed] })
                .then(msg => {
                    ...
                    // if (!isMaintenance())
                    //     client.channels.cache.get(log.countingplus.numbers).send({ embeds: [embed] })
                })
...
:point_right: Ora si ricomincia da \`${serverstats.countingplus.number}\` e ogni volta si ${serverstats.countingplus.operator == "+" ? "**aggiunge**" : serverstats.countingplus.operator == "-" ? "**sottrae**" : "**moltiplica** per"} \`${serverstats.countingplus.gap}\``
            ...
            // User best score: ${numero > userstats.countingplus.bestScore ? "Yes" : "No"}
            // Server best score: ${numero > serverstats.countingplus.bestScore ? "Yes" : "No"}`)
