...
module.exports = {
    ...
    async execute(client, ban) {
        ...
        if (!userstats) userstats = addUser(interaction.guild.members.cache.get(logs.target.id) || logs.target)[0]
        ...
        if (userstats.moderation.type == "Forcebanned") {
            ...
            userstats.warns[userstats.warns.reverse().findIndex(x => x.type == "ban" || x.type == "fban" || x.type == "tempban")].unModerator = logs.executor.id
